//! Kani proof: Access control for `initialize_price_state`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:180
//! Invariant: Instruction 'initialize_price_state' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_initialize_price_state_access_control() {
