//! Kani proof: Bounds check for `SecureVault`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: secure_vault_mod.rs:263
//! Invariant: Account 'SecureVault' balance fields (total_assets, total_shares) must be within valid range [0, u64::MAX]
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_securevault_balance_fields_bounded() {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_securevault_balance_fields_bounded_fee_bps() {
