//! Kani proof: Access control for `vote_on_proposal`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:211
//! Invariant: Instruction 'vote_on_proposal' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_vote_on_proposal_access_control() {
