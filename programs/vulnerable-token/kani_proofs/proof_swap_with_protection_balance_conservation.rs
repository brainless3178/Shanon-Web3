//! Kani proof: Balance conservation for `swap_with_protection`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:64
//! Invariant: Token/SOL balance changes in 'swap_with_protection' must conserve total supply (no creation from nothing)
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_swap_with_protection_balance_conservation() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_swap_with_protection_balance_conservation_transitive() {
