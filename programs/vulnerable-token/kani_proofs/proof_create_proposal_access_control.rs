//! Kani proof: Access control for `create_proposal`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:240
//! Invariant: Instruction 'create_proposal' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_create_proposal_access_control() {
