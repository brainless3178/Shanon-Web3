//! Kani proof: Balance conservation for `deposit`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:94
//! Invariant: Token/SOL balance changes in 'deposit' must conserve total supply (no creation from nothing)
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_deposit_balance_conservation() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_deposit_balance_conservation_transitive() {
