//! Kani proof: Access control for `handle_transfer_with_fee_check`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: token_extensions_mod.rs:8
//! Invariant: Instruction 'handle_transfer_with_fee_check' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_handle_transfer_with_fee_check_access_control() {
