//! Kani proof: Arithmetic safety for `record_observation`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: secure_oracle_mod.rs:method
//! Invariant: All arithmetic in 'record_observation' must not overflow/underflow

#[cfg(kani)]
mod kani_proofs {
    /// Verify that all arithmetic operations in `record_observation` are overflow-safe
    /// at the bit-precise u64 level.
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_record_observation_arithmetic_safety() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_record_observation_arithmetic_safety_checked() {
        let a: u64 = kani::any();
        let b: u64 = kani::any();
