//! Kani proof: Arithmetic safety for `verify_pda`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: pda_utils.rs:3
//! Invariant: All arithmetic in 'verify_pda' must not overflow/underflow at u64 boundary

#[cfg(kani)]
mod kani_proofs {
    /// Verify that all arithmetic operations in `verify_pda` are overflow-safe
    /// at the bit-precise u64 level.
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_verify_pda_arithmetic_safety() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_verify_pda_arithmetic_safety_checked() {
        let a: u64 = kani::any();
        let b: u64 = kani::any();
