//! Kani proof: Balance conservation for `create_voting_escrow`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:107
//! Invariant: Token/SOL balance changes in 'create_voting_escrow' must conserve total supply (no creation from nothing)
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_create_voting_escrow_balance_conservation() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_create_voting_escrow_balance_conservation_transitive() {
