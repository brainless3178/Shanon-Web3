//! Kani proof: Access control for `initialize_pool`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:196
//! Invariant: Instruction 'initialize_pool' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_initialize_pool_access_control() {
