//! Kani proof: Access control for `reset_circuit_breaker`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:189
//! Invariant: Instruction 'reset_circuit_breaker' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_reset_circuit_breaker_access_control() {
