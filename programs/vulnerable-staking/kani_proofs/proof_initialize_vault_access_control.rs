//! Kani proof: Access control for `initialize_vault`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:151
//! Invariant: Instruction 'initialize_vault' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_initialize_vault_access_control() {
