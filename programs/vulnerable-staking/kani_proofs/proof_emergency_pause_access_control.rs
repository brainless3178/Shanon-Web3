//! Kani proof: Access control for `emergency_pause`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:131
//! Invariant: Instruction 'emergency_pause' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_emergency_pause_access_control() {
