//! Kani proof: Bounds check for `VotingEscrow`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: flash_loan_defense_mod.rs:4
//! Invariant: Account 'VotingEscrow' balance fields (amount) must be within valid range [0, u64::MAX]
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_votingescrow_balance_fields_bounded() {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_votingescrow_balance_fields_bounded_fee_bps() {
