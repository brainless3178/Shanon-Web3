//! Kani proof: Access control for `withdraw`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:160
//! Invariant: Instruction 'withdraw' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_withdraw_access_control() {
