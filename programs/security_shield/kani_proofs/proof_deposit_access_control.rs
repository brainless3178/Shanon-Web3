//! Kani proof: Access control for `deposit`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:94
//! Invariant: Instruction 'deposit' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_deposit_access_control() {
