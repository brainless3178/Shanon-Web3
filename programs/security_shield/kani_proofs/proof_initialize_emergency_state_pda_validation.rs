//! Kani proof: PDA validation for `initialize_emergency_state`
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_initialize_emergency_state_pda_validation() {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_initialize_emergency_state_pda_validation_bump() {
        let bump: u8 = kani::any();
