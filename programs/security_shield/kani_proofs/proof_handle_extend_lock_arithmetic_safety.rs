//! Kani proof: Arithmetic safety for `handle_extend_lock`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: flash_loan_defense_mod.rs:59
//! Invariant: All arithmetic in 'handle_extend_lock' must not overflow/underflow at u64 boundary

#[cfg(kani)]
mod kani_proofs {
    /// Verify that all arithmetic operations in `handle_extend_lock` are overflow-safe
    /// at the bit-precise u64 level.
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_handle_extend_lock_arithmetic_safety() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_handle_extend_lock_arithmetic_safety_checked() {
        let a: u64 = kani::any();
        let b: u64 = kani::any();
