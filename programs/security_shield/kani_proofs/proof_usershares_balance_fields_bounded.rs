//! Kani proof: Bounds check for `UserShares`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: secure_vault_mod.rs:292
//! Invariant: Account 'UserShares' balance fields (amount) must be within valid range [0, u64::MAX]
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_usershares_balance_fields_bounded() {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_usershares_balance_fields_bounded_fee_bps() {
