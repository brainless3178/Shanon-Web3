//! Kani proof: Access control for `swap_with_protection`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:64
//! Invariant: Instruction 'swap_with_protection' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_swap_with_protection_access_control() {
