//! Kani proof: Access control for `execute_proposal`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:256
//! Invariant: Instruction 'execute_proposal' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_execute_proposal_access_control() {
