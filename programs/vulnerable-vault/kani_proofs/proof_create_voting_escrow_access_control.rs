//! Kani proof: Access control for `create_voting_escrow`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:107
//! Invariant: Instruction 'create_voting_escrow' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_create_voting_escrow_access_control() {
