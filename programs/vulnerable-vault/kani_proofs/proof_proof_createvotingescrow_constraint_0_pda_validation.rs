//! Kani proof: PDA validation for `proof_createvotingescrow_constraint_0`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: proof_solana_createvotingescrow.rs:28
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_proof_createvotingescrow_constraint_0_pda_validation() {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_proof_createvotingescrow_constraint_0_pda_validation_bump() {
        let bump: u8 = kani::any();
