//! Kani proof: Arithmetic safety for `proof_votingescrow_balance_fields_bounded`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: proof_votingescrow_balance_fields_bounded.rs:11
//! Invariant: All arithmetic in 'proof_votingescrow_balance_fields_bounded' must not overflow/underflow at u64 boundary

#[cfg(kani)]
mod kani_proofs {
    /// Verify that all arithmetic operations in `proof_votingescrow_balance_fields_bounded` are overflow-safe
    /// at the bit-precise u64 level.
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_proof_votingescrow_balance_fields_bounded_arithmetic_safety() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_proof_votingescrow_balance_fields_bounded_arithmetic_safety_checked() {
        let a: u64 = kani::any();
        let b: u64 = kani::any();
