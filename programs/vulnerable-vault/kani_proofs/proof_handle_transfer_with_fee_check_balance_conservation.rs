//! Kani proof: Balance conservation for `handle_transfer_with_fee_check`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: token_extensions_mod.rs:4
//! Invariant: Token/SOL balance changes in 'handle_transfer_with_fee_check' must conserve total supply (no creation from nothing)
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_handle_transfer_with_fee_check_balance_conservation() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_handle_transfer_with_fee_check_balance_conservation_transitive() {
