//! Kani proof: Access control for `handle_auto_pause`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: auto_response.rs:11
//! Invariant: Instruction 'handle_auto_pause' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_handle_auto_pause_access_control() {
