//! Kani proof: Access control for `initialize_user_shares`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:172
//! Invariant: Instruction 'initialize_user_shares' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_initialize_user_shares_access_control() {
