//! Kani proof: Access control for `extend_lock`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:225
//! Invariant: Instruction 'extend_lock' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_extend_lock_access_control() {
