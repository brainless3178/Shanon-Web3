//! Kani proof: PDA validation for `proof_swapwithprotection_constraint_1`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: proof_solana_swapwithprotection.rs:50
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_proof_swapwithprotection_constraint_1_pda_validation() {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_proof_swapwithprotection_constraint_1_pda_validation_bump() {
        let bump: u8 = kani::any();
