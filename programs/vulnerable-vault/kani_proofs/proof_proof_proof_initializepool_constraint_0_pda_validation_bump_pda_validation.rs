//! Kani proof: PDA validation for `proof_proof_initializepool_constraint_0_pda_validation_bump`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: proof_proof_initializepool_constraint_0_pda_validation.rs:51
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_proof_proof_initializepool_constraint_0_pda_validation_bump_pda_validation() {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_proof_proof_initializepool_constraint_0_pda_validation_bump_pda_validation_bump() {
        let bump: u8 = kani::any();
