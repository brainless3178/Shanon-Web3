//! Kani proof: PDA validation for `proof_voteonproposal_constraint_3`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: proof_solana_voteonproposal.rs:70
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_proof_voteonproposal_constraint_3_pda_validation() {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_proof_voteonproposal_constraint_3_pda_validation_bump() {
        let bump: u8 = kani::any();
