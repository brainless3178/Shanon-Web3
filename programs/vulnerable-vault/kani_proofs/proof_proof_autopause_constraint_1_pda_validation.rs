//! Kani proof: PDA validation for `proof_autopause_constraint_1`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: proof_solana_autopause.rs:40
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_proof_autopause_constraint_1_pda_validation() {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_proof_autopause_constraint_1_pda_validation_bump() {
        let bump: u8 = kani::any();
