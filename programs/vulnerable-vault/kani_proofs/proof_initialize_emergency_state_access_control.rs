//! Kani proof: Access control for `initialize_emergency_state`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:123
//! Invariant: Instruction 'initialize_emergency_state' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_initialize_emergency_state_access_control() {
