//! Kani proof: Access control for `withdraw_from_escrow`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:233
//! Invariant: Instruction 'withdraw_from_escrow' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_withdraw_from_escrow_access_control() {
