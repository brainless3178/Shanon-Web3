//! Kani proof: Balance conservation for `verify_transfer_amount`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:41
//! Invariant: Token/SOL balance changes in 'verify_transfer_amount' must conserve total supply (no creation from nothing)
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_verify_transfer_amount_balance_conservation() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_verify_transfer_amount_balance_conservation_transitive() {
